...
2. **Ingest** - Continuously ingests your data with real-time webhooks and periodic API syncs
...
### Self-hosting
We are working on making Grapevine **self-hostable**, so you can run it on your own infrastructure. If you are interested in trying out this experience, [contact us](mailto:grapevine@gather.town).
