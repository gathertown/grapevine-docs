...
Webhooks can only be created through the [Webhooks page](https://app.getgrapevine.ai/webhooks) in your dashboard.
...
After the final retry attempt, Grapevine will stop retrying.
