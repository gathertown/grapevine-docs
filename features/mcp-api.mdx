...
For more information on how to setup your Grapevine tenant, see [Getting Started](/getting-started/quickstart). For more information on how you can authenticate with the MCP, see the [Authentication](/getting-started/authentication) page.
